...
import com.ashvanee.upi.Common.Service;
...
public class PaytmActivity extends AppCompatActivity {
    ...
    private String midString ="jZOFCd42191380484219", txnAmountString="", orderIdString="", txnTokenString="";
...
// nextInt as provided by Random is exclusive of the top value so you need to add 1
        ...
        orderIdString =  date+String.valueOf(randomNum);  // Txn Id
    ...
    private  void getToken(){
        ...
        Call<Token_Res> call = service.getTokenCall("12345", midString, orderIdString, txnAmountString);
